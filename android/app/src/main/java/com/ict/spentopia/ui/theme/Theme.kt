...
private val DarkColorScheme = darkColorScheme( // DarkColorScheme 값을 저장함
    ...
    primaryContainer = SpentopiaGradientEnd, // primaryContainer 값을 정해줌
...
private val LightColorScheme = lightColorScheme( // LightColorScheme 값을 저장함
    ...
    primaryContainer = SpentopiaLightButton, // 라이트모드 카드/버튼 배경을 밝은 스카이블루로 정함
    onPrimaryContainer = SpentopiaLightButtonContent, // 밝은 블루 배경 위에 읽히는 진한 블루 글자색임
    secondaryContainer = Color(0xFFF0F7FF), // 일반 보조 영역은 더 밝은 하늘색으로 정함
